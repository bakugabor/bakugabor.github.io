...
const gallerySets = {
  ppf: ['gallery-ppf-mustang.jpeg','gallery-ppf-dodge.jpeg','gallery-ppf-display-bmw.jpeg','gallery-ppf-bmw-exterior.jpeg','gallery-ppf-display-skoda.jpeg'],
  tint: ['gallery-tint-camaro-side-rear.jpeg','gallery-tint-camaro-side.jpeg','gallery-tint-camaro-door.jpeg','gallery-tint-camaro-rear-indoor.jpeg','gallery-tint-camaro-rear.jpeg','gallery-tint-skoda-side.jpeg','gallery-tint-skoda-rear.jpeg','gallery-tint-mustang.jpeg','gallery-tint-mustang-window.jpeg','gallery-tint-ora.jpeg','gallery-tint-ora-window.jpeg','gallery-tonovanie-skiel.jpeg','gallery-tint-01-skoda-white.jpeg','gallery-tint-02-skoda-karoq.jpeg','gallery-tint-03-toyota-van.jpeg','gallery-tint-04-panoramic-roof.jpeg','gallery-tint-05-fiat-van.jpeg','gallery-tint-06-mg-suv.jpeg','gallery-tint-07-mercedes.jpeg','gallery-tint-08-opel.jpeg','gallery-tint-09-mitsubishi.jpeg','gallery-tint-10-kia.jpeg'],
...
document.querySelectorAll('.gallery-slider').forEach((slider) => {
  ...
  photos.forEach((_, dotIndex) => {
    ...
    dot.type = 'button';
    dot.setAttribute('aria-label', `Kép ${dotIndex + 1}`);
...
function updateLightbox() {
  ...
  lightbox.querySelector('img').alt = `${activeSlider.title} – nagyított kép`;
